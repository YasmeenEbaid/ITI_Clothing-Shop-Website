...
const cartList = document.getElementById('CartTab');
let showingCart = document.getElementById('carticon');
...
showingCart.addEventListener('click', () => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('ListCart').addEventListener('click', function(e) {
...
function attachQuantityListeners(cartItem) {
    ...
    const quantityElement = cartItem.querySelector('.quantity span:nth-child(2)');
...
document.querySelectorAll('.icon-product #carticon').forEach(cartIcon => {
